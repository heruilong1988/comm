...
public class StreamBinanceUmFutureDiffDepthEvent {
	@JsonProperty("e")
	...
	public static StreamBinanceUmFutureDiffDepthEvent fromJson(String depthEventString) {
		try {
			return serializationInstance.getObjectMapper().readValue(depthEventString, StreamBinanceUmFutureDiffDepthEvent.class);

package com.hrl.trade.common.api.client.binance.spot.stream.orderbook;
...
@Getter
@Setter
public class BinanceSpotOrderBookMaintainer {
    ...
    public BinanceSpotOrderBookMaintainer(HClient restBinanceUmFutureClient, Platforms platforms) {
     ...
     */
    public WebSocketMessageCallback onDiffDepthEventMessageCallback = new WebSocketMessageCallback() {
        @Override
